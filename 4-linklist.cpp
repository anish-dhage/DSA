...
class LinkList{
        ...
        void display(){
        	...
        	while(new1!=NULL){
        		...
        		cout<<"Name : "<< new1->name << endl <<"PRN Number : "<< new1->prn <<endl<<"Designation : "<< new1->desg << endl ;
        		new1 = new1->next;
        ...
        void revdisplay(Node *head){
        	...
        	revdisplay(head->next);
       		cout<<"Name : "<< head->name << endl <<"PRN Number : "<< head->prn <<endl<<"Designation : "<< head->desg << endl ;
